            ...
            <div className="menu-container">
                <h1 className="calligraphy-font primaryfontcol">James Diffey</h1>
                    ...
                    <ul className="links-container">
                        <a target="_blank" href="https://github.com/jamesdiffeycoding" className="links-item primaryfontcol">  
                        ...
                        <a target="_blank" href="https://linkedin.com/jamesdiffey" className="links-item primaryfontcol"> 
                        ...
                        <a target="_blank" href="#" className="links-item primaryfontcol">  
                    ...
                    <section className="projects-container">
                        ...
                        <div className="project-box">
                            <div className="arrow left-arrow">l</div>
                            <div className="arrow right-arrow">r</div>
