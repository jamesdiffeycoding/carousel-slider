const skillsData =[
    ...
    },
    {
        ...
        information: "As a Master's Graduate and Imperial College London Researcher, I am experienced in analytical tasks, working with data, and producing written outputs that are easy to digest.",
    ...
    {
        title: "Technologies",
        information: "I use a range of front-end, back-end, and code-management technologies - and I'm really keen to learn more.",
